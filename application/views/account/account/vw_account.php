                            ...
                            <div class="item-settings flex flex-direction-col flex-gap-semi-large item-settings-unset">
                                <div class="b-bot-settings p-border flex flex-direction-col flex-gap-semi-large">
                                    ...
                                    <div class="flex flex-gap-regular w-100 column-mobile">
                                        <div
                                            ...
                                            <label class="label-profile-setting" for="full-name-field">Full name <span
                                                    id="full-name-field-error" style="display: none;"></span></label>
                                            <input id="full-name-field" type="text"
                                                class="input-profile-setting mobile-flex-full" placeholder="Full name">
                                        </div>
                                        <div
                                            class="flex flex-direction-col flex-gap-semi-small mobile-flex-full-important w-50">
                                            <label class="label-profile-setting" for="username-field">Username</label>
                                            <input id="username-field" type="text"
                                                class="input-profile-setting mobile-flex-full" placeholder="Username">
                                        </div>
                                    </div>
                                    <div class="flex flex-direction-col flex-gap-regular">
                                        ...
                                        <div class="ck ck-reset ck-editor ck-rounded-corners" role="application"
                                            dir="ltr" lang="en"
                                            aria-labelledby="ck-editor__label_ed05c7c2ee9492052ef7fcc8b4af5f97c"><label
                                ...
                                <div class="flex flex-direction-col flex-gap-semi-large">
                                    ...
                                    <div class="flex flex-gap-regular w-100 column-mobile">
                                        <div
                                            class="flex flex-direction-col flex-gap-semi-small mobile-flex-full-important w-50">
                                            <label for="email-field" class="label-profile-setting">Email address <span
                                                    id="email-field-error" style="display: none;"></span></label> <input
                                                id="email-field" type="text"
                                        ...
                                        <div
                                            ...
                                            <label for="phone-number-field" class="label-profile-setting">Phone
                                                ...
                                                class="input-profile-setting-2 phone-number mobile-flex-full" name=""
                                    ...
                                    <div class="flex flex-gap-regular w-100 b-bot-settings p-border column-mobile">
                                        <div
                                            ...
                                            <div id="country-field"
                                                class="input-profile-setting-2 padding-unset mobile-flex-full"><select
