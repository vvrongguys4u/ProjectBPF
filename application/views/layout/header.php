                            ...
                            <div class="header_content d-flex flex-row align-items-center justify-content-between">
                                ...
                                <nav class="main_nav_container">
                                    <ul class="main_nav">
                                        ...
                                        <li class="active"><a href="<?= base_url('statistic'); ?>">Statistic</a></li>
                                    </ul>
                                </nav>
                                ...
                                <div class="user-section d-flex flex-row align-items-center">
                                    <div class="user ml-2">
                                        <a href="<?= base_url('statistic/vw_statistic'); ?>"><i class="fa fa-user" aria-hidden="true"></i></a>
                                    </div>
                                    <div class="user_greeting ml-2">
                                        <?php
                                        if ($this->session->userdata('Email')) {
                                            echo 'Welcome! ' . $this->session->userdata('Email');
                                            echo '<a href="' . base_url('auth') . '" class="ml-2">Logout</a>';
                                        } else {
